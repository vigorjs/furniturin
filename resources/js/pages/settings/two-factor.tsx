    ...
    <SettingsLayout>
      ...
      <div>
        <HeadingSmall
          ...
          description={t('settings.two_factor.title')}
        />
          ...
          {twoFactorEnabled ? (
            <div className="flex flex-col items-start justify-start space-y-4">
              ...
              <p className="text-terra-500">
                ...
                memasukkan PIN keamanan saat login. PIN ini dapat diambil dari
                aplikasi TOTP di ponsel Anda (seperti Google Authenticator atau
                Authy).
              </p>
            ...
            <div className="flex flex-col items-start justify-start space-y-4">
              ...
              <p className="text-terra-500">
                ...
                pada akun Anda. Anda akan diminta memasukkan PIN dari aplikasi
                TOTP setiap kali login.
              </p>
