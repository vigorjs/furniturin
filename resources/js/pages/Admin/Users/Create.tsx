        ...
        <AdminLayout breadcrumbs={[
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-terra-900">Tambah User Baru</h1>
                        <p className="text-terra-500 mt-1">Buat akun user admin baru</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 shadow-sm border border-terra-100 space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-terra-700 mb-2">Password</label>
