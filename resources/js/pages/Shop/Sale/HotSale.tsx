...
export default function HotSale({
  ...
  // Normalize categories to handle API wrapping
        ...
        <main className="min-h-screen bg-neutral-50 pb-20">
          ...
          >
            <div className="mx-auto max-w-[1400px] px-6 text-center md:px-12">
              ...
              >
                <Flame size={40} className="animate-pulse text-accent-500" />
              ...
              {siteSettings?.hot_sale_end_date &&
                siteSettings?.hot_sale_timer_visible && (
                  <motion.div
                    variants={itemVariants}
                    className="mx-auto mt-8 max-w-xl"
                  >
                    <FlashSaleCountdown
                      endDate={new Date(siteSettings.hot_sale_end_date)}
                      title="Offer Ends In"
          ...
          <div className="mx-auto max-w-[1400px] px-6 md:px-12">
            ...
            {showFilters && (
              ...
              >
                <h3 className="mb-4 font-medium text-neutral-800">Category</h3>
            ...
            {products.data.length > 0 ? (
              ...
              <div className="rounded-sm bg-white py-20 text-center">
                <Flame size={48} className="mx-auto mb-4 text-neutral-300" />
