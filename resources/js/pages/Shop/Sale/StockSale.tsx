...
export default function StockSale({ products, categories, filters }: Props) {
    ...
    const handleSort = (sort: string) => {
        router.get('/shop/stock-sale', { ...safeFilters, sort }, { preserveState: true });
    };
    ...
    const handleCategoryFilter = (categoryId: number | null) => {
        ...
        router.get('/shop/stock-sale', { filter: newFilters, sort: safeFilters.sort }, { preserveState: true });
    };
                ...
                <div className="bg-gradient-to-r from-terra-900 to-terra-700 text-white py-16 mb-12">
                    <div className="max-w-[1400px] mx-auto px-6 md:px-12 text-center">
                        <div className="flex items-center justify-center gap-3 mb-4">
                            ...
                            <h1 className="font-serif text-4xl md:text-5xl font-bold">STOCK SALE</h1>
                        ...
                        <div className="flex flex-wrap justify-center gap-6 mt-8">
                            <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full">
                                <span className="w-2 h-2 bg-wood-light rounded-full"></span>
        ...
        <Link href={`/shop/products/${product.slug}`} className="group bg-white rounded-2xl overflow-hidden border border-terra-100 hover:shadow-lg transition-all">
            <div className="relative aspect-square overflow-hidden">
                ...
                {product.stock_quantity && product.stock_quantity > 0 && (
                    <span className="absolute bottom-3 left-3 bg-wood text-white px-3 py-1 rounded-full text-xs">Stok: {product.stock_quantity}</span>
                )}
            </div>
            <div className="p-4">
                ...
                <div className="flex items-end gap-2">
                    <span className="text-lg font-bold text-terra-900">{product.final_price_formatted}</span>
