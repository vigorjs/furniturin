...
export function FlashSaleCountdown({
  ...
  if (isExpired) {
    return (
      <div className={`rounded-sm p-6 text-center text-white ${className}`}>
        <div className="mb-2 flex items-center justify-center gap-2">
          <Flame className="text-neutral-400" size={24} />
          <h3 className="text-lg font-medium">Flash Sale Telah Berakhir</h3>
        </div>
        <p className="text-sm opacity-80">Nantikan promo menarik berikutnya!</p>
      </div>
    );
  }
