...
export const CategoriesSection: React.FC<CategoriesSectionProps> = ({
  categories,
  title = 'Shop by Room',
  subtitle = 'Explore our curated collections designed with care for every space in your home.',
}) => {
  // If we have less than 4, we adjust the grid (not slicing to 4 strictly unless needed)
  // Actually, let's keep showing all managed categories but maybe limit if too many?
  // For now, let's show up to 6 effectively if grid allows, or stick to 4.
  // The previous code sliced to 4. Let's keep it but maybe increase if needed.
  ...
  return (
    <section className="bg-neutral-50 px-6 pt-24 md:px-12">
      <div className="mx-auto max-w-[1400px]">
        ...
        {/* Category Grid - Dynamic based on count */}
        <motion.div
          initial="hidden"
          whileInView="visible"
